...
export function nothing(chosen: Chosen, searching: boolean, tracesHidden = 0): string {
  ...
  if (chosen.named === "archive") {
    ...
    if (layer === "trace" && tracesHidden > 0) return fill("traceHidden", String(tracesHidden));
    return t(
