...
export default function TaskList({
  ...
  return (
    <main className="flex flex-col overflow-hidden">
      <header className={`flex items-baseline gap-2.5 px-8 pt-2.5 pb-3.5 ${width}`}>
      ...
      <div className={`scroller flex-1 px-5 pb-6 ${width}`}>
        ...
        {tasks.map((task) => (
          <div
            ...
            className={`grid cursor-pointer grid-cols-[20px_1fr_auto] items-start gap-2.5 rounded-lg px-2.5 py-2 hover:bg-hover ${
