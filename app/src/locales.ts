const en = {
  ...
  logsTitle: "Log",
  logsWhat: "Anything that goes wrong, from a warning up, is written down here.",
  logsPrivate: "Nothing about your tasks reaches it: no titles, no descriptions, no journals. The shape of what gets recorded cannot carry them, and paths come out with your account name hidden.",
  logsWeighs: "{name} on disk",
  logsQuiet: "Nothing has gone wrong yet.",
  logsOpen: "Open the file",
  logsSave: "Save a copy…",
  logsForget: "Empty it",
  logsForgot: "Emptied",
  logsSure: "Empty the log? What it holds is the only account of whatever has gone wrong on this machine.",
  logsAll: "Record what works too, not only what fails",
  logsAllWhy: "Noisier by a lot, and only worth it while chasing something. It goes back off on its own next time Tisty starts.",
  logsShow: "See what it holds",
  ...
  attachBig: "For anything large it is better to write a document and reference it from the task, instead of dragging the whole file in.",
  ...
  reportWhat: "Saves a text file with what it takes to understand a fault: version, operating system and counts.",
...
const es: Catalog = {
  ...
  logsTitle: "Registro",
  logsWhat: "Todo lo que sale mal, de aviso para arriba, queda escrito aquí.",
  logsPrivate: "Nada de tus tareas llega hasta él: ni títulos, ni descripciones, ni bitácoras. La forma de lo que se registra no puede llevarlos, y las rutas salen con tu nombre de usuario tapado.",
  logsWeighs: "{name} en disco",
  logsQuiet: "Todavía no ha salido nada mal.",
  logsOpen: "Abrir el fichero",
  logsSave: "Guardar una copia…",
  logsForget: "Vaciarlo",
  logsForgot: "Vaciado",
  logsSure: "¿Vaciar el registro? Lo que guarda es el único relato de lo que haya salido mal en este equipo.",
  logsAll: "Registrar también lo que funciona, no solo lo que falla",
  logsAllWhy: "Mucho más ruidoso, y solo vale la pena mientras persigues algo. Se apaga solo la próxima vez que arranque Tisty.",
  logsShow: "Ver lo que guarda",
  ...
  storeFixed: "La carpeta no se puede cambiar: tus tareas son ficheros de texto, y saber siempre dónde están es parte de que sean tuyas.",
  attachBig: "Para material grande es preferible crear un documento y referenciarlo desde la tarea, en vez de arrastrar el fichero entero.",
  ...
  reportWhat: "Guarda un fichero de texto con lo que hace falta para entender un fallo: versión, sistema operativo y cifras.",
  ...
  reportNoClipboard: "El portapapeles lo rechazó — guarda el fichero en su lugar",
