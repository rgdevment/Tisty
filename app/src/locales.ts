const en = {
  ...
  howToShowIt: "How should it look?",
  asACard: "As a card",
  asALink: "As a link",
  moreOnIt: "More",
...
const es: Catalog = {
  ...
  howToShowIt: "¿Cómo quieres verlo?",
  asACard: "Como tarjeta",
  asALink: "Como enlace",
  moreOnIt: "Más",
  ...
  editStep: "Paso: {name}",
  strandedPapers: "Hay {name} ficheros de documento en disco que el registro no conoce. Vienen de una máquina que los borró, o de una copia interrumpida.",
  archivedList: "La lista «{name}» está guardada. Recupérala antes de archivar nada en ella.",
  documentTooLong: "Este documento llegó a {name}. Quita algo o pártelo en dos — pasado ese punto ya no se puede leer ni llevar.",
