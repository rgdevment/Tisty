const en = {
  ...
  packAllWhy:
    "One file with every document, its folders and what they carry, to hand to somebody. It is not a backup: importing it twice makes a second copy, and moving to another machine of your own is what the backup is for.",
  packWho: "Who is this for?",
  packWhoWhy:
    "A parcel for somebody else lands there as theirs. One for another machine of your own is locked with a number, and lands there as yours.",
  ...
  packNumberWhy: "You will be asked for these six digits when you open it on the other machine.",
  packLockIt: "Lock and export…",
  parcelLocked: "That parcel is locked. If it is yours, the number it was locked with opens it.",
...
const es: Catalog = {
  ...
  packAllWhy:
    "Un archivo con todos los documentos, sus carpetas y lo que llevan dentro, para dárselo a alguien. No es una copia de seguridad: importarlo dos veces deja todo duplicado, y para cambiar a otro equipo tuyo está el respaldo.",
  packWho: "¿Para quién es?",
  packWhoWhy:
    "Lo que le das a otra persona llega allí como suyo. Lo que llevas a otro equipo tuyo se cierra con un número, y llega allí como tuyo.",
  ...
  packNumberWhy: "Estos seis dígitos te los pedirá el otro equipo al abrirlo.",
  packLockIt: "Cerrar y exportar…",
  parcelLocked: "Ese archivo está cerrado. Si es tuyo, lo abre el número con el que se cerró.",
