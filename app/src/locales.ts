const en = {
  ...
  packed: "Packed with {name} documents",
  packedAlone: "Packed",
  ...
  landedShort: "It came in, but {name} of the files it points at did not fit and stayed out",
  notAParcel: "{name} is not a Tisty parcel",
...
const es: Catalog = {
  ...
  packed: "Empaquetado con {name} documentos",
  packedAlone: "Empaquetado",
  ...
  landedShort: "Entró, pero {name} de los archivos a los que apunta no cupieron y quedaron fuera",
  notAParcel: "{name} no es un paquete de Tisty",
