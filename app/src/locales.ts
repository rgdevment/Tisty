const en = {
  ...
  goneDoc: "That document has not arrived on this machine yet",
...
const es: Catalog = {
  ...
  goneDoc: "Ese documento todavía no ha llegado a esta máquina",
