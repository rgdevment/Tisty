const en = {
  ...
  updateBrew: "Run brew upgrade --cask tisty",
  updateBrewCli: "Run brew upgrade tisty-cli",
...
const es: Catalog = {
  ...
  updateBrew: "Ejecuta brew upgrade --cask tisty",
  updateBrewCli: "Ejecuta brew upgrade tisty-cli",
