const en = {
  ...
  dropThemSure: "Discard {name} tasks? They leave the open lists and wait 30 days in the bin.",
  ...
  sayDeadline: "due by…",
  sayPriority: "do · decide · delegate",
...
const es: Catalog = {
  ...
  dropThemAll: "Descartarlas todas",
  urgentAxis: "Urgente",
  ...
  dropThemSure:
    "¿Descartar {name} tareas? Salen de las listas abiertas y esperan 30 días en la papelera.",
  ...
  sayPriority: "hacer · decidir · delegar",
