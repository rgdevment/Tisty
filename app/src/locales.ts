...
const es: Catalog = {
  ...
  attachWhy: "El fichero más grande que Tisty acepta. Todo lo que adjuntas se copia al almacén, así viaja con tus tareas y sigue ahí en el otro equipo.",
  attachUpTo: "aceptar ficheros de hasta",
  tasks: "Tareas",
  ...
  attachmentTooBig: "Ese fichero pasa de {name}. Para algo así, crea un documento y referéncialo desde la tarea; o sube el límite en Configuración.",
  ...
  attachBig: "Para algo más grande, crea un documento y referéncialo desde la tarea en vez de arrastrar el fichero.",
  ...
  reportLogsWhy: "Lo que ha fallado en este equipo, de aviso para arriba. No lleva títulos, ni descripciones, ni bitácoras: el registro no puede guardarlos.",
