const en = {
  ...
  docsSoon: "Documents are still in development, so for now this is a recommendation, not an alternative.",
...
const es: Catalog = {
  ...
  docsSoon: "Los documentos todavía están en desarrollo, así que por ahora esto es una recomendación, no una alternativa.",
