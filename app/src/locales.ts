const en = {
  ...
  trailRebounded: "The deadline moves to {name}",
  ...
  trailUndone: "undone",
  trailSealed:
    "This trail is not edited. Reopening sends it back to Today and opens a new chapter; nothing before it is erased.",
...
const es: Catalog = {
  ...
  trailRebounded: "El límite se corre al {name}",
  ...
  trailSealed:
    "Este trayecto no se edita. Reabrirla la devuelve a Hoy y abre un capítulo nuevo; nada de lo anterior se borra.",
