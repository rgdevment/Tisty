const en = {
  ...
  aboutAlternative: "Tisty on AlternativeTo",
  badgeLocal: "All local",
  badgeOpen: "Open source",
  badgeFree: "Free",
  badgeQuiet: "No telemetry",
  starThanks: "Thank you for using Tisty.",
  starWhy: "No telemetry and no ads: it is only found when somebody says so.",
...
const es: Catalog = {
  ...
  aboutAlternative: "Tisty en AlternativeTo",
  badgeLocal: "Todo local",
  badgeOpen: "Código abierto",
  badgeFree: "Gratis",
  badgeQuiet: "Sin telemetría",
  starThanks: "Gracias por usar Tisty.",
  starWhy: "Sin telemetría ni anuncios: solo se encuentra si alguien lo dice.",
  starGo: "Dar una estrella",
  starNo: "No, gracias",
