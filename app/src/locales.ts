const en = {
  ...
  toPdf: "Export to PDF…",
  copied: "Copied without underline or alignment",
  bigTitle: "Heading",
  midTitle: "Subheading",
  ...
  alignBoth: "Justify",
  wouldRuin: "That change cannot be written as Markdown, so it was not saved. Undo it to keep writing.",
  putAway: "Archive",
  bringBack: "Unarchive",
  deleteIt: "Delete",
  copyOf: "{name} (copy)",
...
const es: Catalog = {
  ...
  copied: "Copiado sin subrayado ni alineación",
  bigTitle: "Título",
  midTitle: "Subtítulo",
  ...
  alignBoth: "Justificar",
  wouldRuin: "Ese cambio no se puede escribir como Markdown, así que no se guardó. Deshazlo para seguir escribiendo.",
  putAway: "Archivar",
