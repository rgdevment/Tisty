const en = {
  ...
  lockingOn: "Locking it… {name}",
  openingOn: "Opening it… {name}",
...
const es: Catalog = {
  ...
  spread: "Reparto",
  spreadTray: "Sin día",
  spreadHeavy: "{name} ya lleva {other}.",
  spreadEmpty: "Nada sin día. Lo que escribes sin fecha espera aquí a que le repartas uno.",
  spreadNow: "Esta semana",
  spreadBack: "La semana anterior",
  spreadOn: "La semana siguiente",
  spreadOff: "Suéltala aquí y se queda sin día.",
  spreadFree: "libre",
  spreadSmall: "pequeña",
  spreadMiddling: "mediana",
  spreadLarge: "grande",
  ...
  family_state: "Marcas",
  family_office: "Oficina",
  family_code: "Programar",
  family_food: "Comida",
  ...
  lockingOn: "Cerrándolo… {name}",
  openingOn: "Abriéndolo… {name}",
