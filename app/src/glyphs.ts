...
const PATHS: string[] = [
  ...
  '<path d="M3 3v16a2 2 0 0 0 2 2h16" /> <path d="M3 11a10 10 0 0 1 10 10" />',
  ...
  '<path d="M6 12h12" /> <rect x="2" y="8" width="20" height="8" rx="4" />',
...
export const known = (name: string): boolean => name in AT;

export const markup = (name: string): string | null => (name in AT ? PATHS[AT[name]] : null);
