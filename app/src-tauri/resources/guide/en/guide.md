...
If you use an assistant, it can file documents and propose tasks of its own accord. What it cannot do is close, delete or touch what you wrote. What it writes is signed with the name of the program it spoke through — «by Claude Code», «by Codex» — so you always know whose hand it was.
